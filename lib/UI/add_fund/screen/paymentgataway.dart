...
class Paymentgataway extends StatefulWidget {
  static const routeName = "Paymentgataway";
  const Paymentgataway({super.key});

  @override
  State<Paymentgataway> createState() => _PaymentgatawayState();
}

class _PaymentgatawayState extends State<Paymentgataway> {
  @override
